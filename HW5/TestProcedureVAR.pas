PROGRAM TestProcedureVAR(input, output);
...
PROCEDURE alpha(m, n : integer; r : real; VAR k, o : integer; 
                VAR w, z : real; VAR q : boolean);
...
PROCEDURE gamma(VAR i, n : integer; x, r : real);
